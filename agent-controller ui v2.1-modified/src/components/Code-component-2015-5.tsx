...
export function WebRTCMonitoring({ selectedAgent }: WebRTCMonitoringProps) {
  const [stats, setStats] = useState(null as WebRTCStats | null);
  const [qualityData, setQualityData] = useState(null as QualityData | null);
  const [productionReadiness, setProductionReadiness] = useState(null as ProductionReadiness | null);
  const [migrationPlan, setMigrationPlan] = useState(null as MigrationPlan | null);
  const [isMonitoring, setIsMonitoring] = useState(false);
  const [selectedQuality, setSelectedQuality] = useState('auto' as 'low' | 'medium' | 'high' | 'auto');
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              }, React.createElement(RefreshCw, { className: `h-4 w-4 ${isMonitoring ? 'animate-spin' : ''}` }), isMonitoring ? 'Stop' : 'Start', " Monitoring")}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Card>
                        ...
                        <CardContent>
                          {React.createElement(Button, {
                            ...
                            className: "w-full"
                          }, React.createElement(TrendingUp, { className: "h-4 w-4 mr-2" }), "Trigger Adaptation")}
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          {React.createElement(Button, {
                            onClick: toggleFrameDropping,
                            className: "w-full"
                          }, React.createElement(ArrowDown, { className: "h-4 w-4 mr-2" }), "Enable Frame Drop")}
                        </CardContent>
                      </Card>
                    </div>
