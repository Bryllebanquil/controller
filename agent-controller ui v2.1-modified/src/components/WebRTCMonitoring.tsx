          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {React.createElement(Button, {
                ...
                React.createElement(RefreshCw, { className: `h-4 w-4 ${isMonitoring ? 'animate-spin' : ''}` }),
                      ...
                      <Card>
                        ...
                        <CardContent>
                          {React.createElement(Button, {
                            ...
                            React.createElement(TrendingUp, { className: "h-4 w-4 mr-2" }),
                            "Trigger Adaptation"
                          )}
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          {React.createElement(Button, {
                            ...
                            React.createElement(ArrowDown, { className: "h-4 w-4 mr-2" }),
                            "Enable Frame Drop"
                          )}
                        </CardContent>
                      </Card>
