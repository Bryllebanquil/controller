  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        ...
        }, React.createElement(Keyboard, { className: "h-4 w-4 mr-2" }), "Shortcuts")}
      </DialogTrigger>
      ...
      {React.createElement(DialogContent, {
        ...
        React.createElement("div", { className: "space-y-6" },
          Object.entries(groupedShortcuts).map(([category, categoryShortcuts]) => 
            React.createElement("div", { key: category },
              React.createElement("h3", { className: "text-sm font-medium mb-3" }, categoryNames[category as keyof typeof categoryNames]),
              React.createElement("div", { className: "space-y-2" },
                categoryShortcuts.map((shortcut, index) => 
                  React.createElement("div", {
                    ...
                    React.createElement("span", { className: "text-sm" }, shortcut.description),
        ...
        React.createElement("div", { className: "mt-6 p-4 bg-muted rounded-lg" },
          React.createElement("p", { className: "text-xs text-muted-foreground" },
            "💡 Press ", React.createElement(Badge, {
              variant: "secondary",
              className: "mx-1 font-mono"
            }, "Ctrl + /"), " to open this dialog anytime"
          )
        )
      )}
    </Dialog>
