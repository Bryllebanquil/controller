        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            {selectedMode === "speech" ? (
              ...
              }, isListening ? React.createElement(MicOff, { className: "h-4 w-4" }) : React.createElement(Mic, { className: "h-4 w-4" }), isListening ? "Stop Listening" : "Start Listening")
            ) : (
              React.createElement(Button, {
                ...
                disabled: !agentId || !isConnected,
                className: "flex items-center gap-2"
              }, isRecording ? React.createElement(Square, { className: "h-4 w-4" }) : React.createElement(Play, { className: "h-4 w-4" }), isRecording ? "Stop Recording" : "Start Recording")
            )}
            ...
            {React.createElement(Button, {
              ...
              size: "sm",
              className: "flex items-center gap-2"
            }, React.createElement(Trash2, { className: "h-4 w-4" }), "Clear History")}
          </div>
