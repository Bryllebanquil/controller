#!/bin/bash
# Script to fix client.py by pulling the correct version from git
...
cd "C:\Users\Brylle\render deploy\controller" || cd "/mnt/c/Users/Brylle/render deploy/controller" || exit
